...
The Online Blood Bank Web Application is a web-based system designed to manage blood donors, blood requests, blood-bank inventory, and communication between donors, patients, hospitals, and administrators. The main purpose is to make finding and requesting blood faster and easier, especially during emergencies.


# 🩸 LifePulse - Online Blood Bank Web Application
...
- 👥 **Donors Directory & ID Pass**: Search verified donors and generate digital Donor Pass with QR code.
